...
WITH base AS (
    ...
    WHERE
        ...
        AND (
            ...
            OR
            (    s.COCONTACONTABIL BETWEEN 632000000 AND 632999999
             AND cc.INCONTACORRENTE = '16'
            )
            OR
            (    s.COCONTACONTABIL BETWEEN 827000000 AND 827999999
             AND cc.INCONTACORRENTE = '16'
            )
            OR
...
WHERE
    ...
    AND (
        (s.COCONTACONTABIL BETWEEN 200000000 AND 299999999
         AND cc.INSISCONTABIL = 'F'
         AND cc.INCONTACORRENTE IN ('63', '76'))
        OR (s.COCONTACONTABIL BETWEEN 632000000 AND 632999999 AND cc.INCONTACORRENTE = '16')
        OR (s.COCONTACONTABIL BETWEEN 827000000 AND 827999999 AND cc.INCONTACORRENTE = '16')
