...
EQUACOES = [
    ...
    # EQ14–EQ16: pares simétricos identificados no diagnóstico de cobertura intra
    {"id": "EQ14", "desc": "218924015 = 112321000",
     "passivo_exact": [218924015], "passivo_prefix": None,
     "ativo": [112321000]},

    {"id": "EQ15", "desc": "228924015 = 121129701",
     "passivo_exact": [228924015], "passivo_prefix": None,
     "ativo": [121129701]},

    {"id": "EQ16", "desc": "218924003 = 112320400",
     "passivo_exact": [218924003], "passivo_prefix": None,
     "ativo": [112320400]},

    # EQ17: Setorial Financeira UG 130101 — passivos intra + série 218924XXX.
...
<header>
  <div style="display:flex;align-items:center">
    ...
    <h1>Correspond&#234;ncia &#8212; Ativo &#215; Passivo &#8212; Painel Unificado
      <span>SIGGO &#183; Exerc&#237;cio 2026 &#183; EQ1&#8211;EQ17 &#8226; Valida&#231;&#227;o</span>
    </h1>
  </div>
...
<div class="aviso">
  <strong>&#9888; Painel de valida&#231;&#227;o &#8212; EQ1&#8211;EQ17.</strong>
  <strong>EQ17 &#8212; Setorial Financeira (UG 130101):</strong> diverg&#234;ncia estrutural esperada.
  O ativo 113829900 registra o pr&#243;prio c&#243;digo como contraparte; o passivo correspondente
  est&#225; em outras UGs &#8212; parte j&#225; capturada em EQ3 e EQ6, parte na s&#233;rie 218924XXX de EQ17.
...
def main():
    ...
    print("Extraindo dados do Oracle (EQ1–EQ17)…")
